    ...
    return(
        ...
        <div className="flex justify-end items-center min-h-screen bg-cover" style={{ backgroundImage: `url(${background})` }}>
            <div className="flex flex-col justify-center items-end p-8">
                ...
                <Link to="/locations" className=" block text-center bg-[#d4a373] text-black font-bold rounded-full py-2 px-4 my-4 hover:bg-[#c99461] hover:text-black hover:border-black active:bg-[#b18458] active:text-black active:border-black delay-100 duration-100 transform hover:scale-110 transition ease-linear animate-bounce  ">
