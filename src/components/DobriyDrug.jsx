...
export default function DobriyDrug() {
  const [establishment, setEstablishment] = useState(null);

  useEffect(() => {
    // Знайдемо заклад "Dogs Like Ducks" у списку та встановимо його в стан
    const foundEstablishment = establishmentsData.find(est => est.name === 'Паб Добрий Друг');
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="relative mb-8 rounded-2xl p-6 bg-white border-2 border-gray-400">
        <img src={restaurants.Friend} className="w-64 h-64 mr-8 rounded-md" alt={restaurants.name} />
