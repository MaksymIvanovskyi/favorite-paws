...
export default function Hashtag() {
  ...
  useEffect(() => {
    ...
    const foundEstablishment = establishmentsData.find(est => est.name === '#Hashtag Lounge Bar');
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="relative mb-8 rounded-2xl p-6 bg-white border-2 border-gray-400">
        <img src={restaurants.Hashtag} className="w-64 h-64 mr-8 rounded-md" alt={restaurants.name} />
